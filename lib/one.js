...
define("1/g", ["require", "exports", "module", "0/Matrix", "0/e"], function(require, exports, module, Matrix, f) {
    function Module(a) {
        ...
        this.Sa = new f([0, 0, 0])
        this.Ca = new f([0, 0, 0])
        this.Qa.set_default_animation({duration: 3000, easing: f.Easing.ease_out_quad})
        this.Sa.set_default_animation({duration: 1000, easing: f.Easing.ease_out_quad})
        this.Ca.set_default_animation({duration: 1000, easing: f.Easing.ease_out_quad})
    }
...
define("1/m", ["require", "exports", "module", "./i", "0/e"], function(require, exports, module, c, f) {
    function Module(a, b) {
        ...
        this.a.ad || (this.a.ad = {duration: 3000, easing: f.Easing.ease_out_quad})
        this.l = new c(this.e)
    }
