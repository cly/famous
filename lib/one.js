    ...
    Module.prototype = {
        b: function(a, b) {
            function d(a, b) {
                ...
                // http://www.samsungdforum.com/upload_files/files/guide/data/html/html_2/api_reference/javascript_apis/common_modules/common_module_widget_object.html
                if (this.a.p) {
...
define("1/g", ["require", "exports", "module", "0/Matrix", "0/e"], function(require, exports, module, Matrix, f) {
    function Module(a) {
        ...
        this.Sa = new f([0, 0, 0])
        this.Ca = new f([0, 0, 0])
        this.Qa.Ta({duration: 3000, q: f.Easing.ease_out_quad})
        this.Sa.Ta({duration: 1000, q: f.Easing.ease_out_quad})
        this.Ca.Ta({duration: 1000, q: f.Easing.ease_out_quad})
    }
...
define("1/m", ["require", "exports", "module", "./i", "0/e"], function(require, exports, module, c, f) {
    function Module(a, b) {
        ...
        this.a.ad || (this.a.ad = {duration: 3000, q: f.Easing.ease_out_quad})
        this.l = new c(this.e)
    }
      ...
      , update: function() {
            if (this.enabled && this.H.length && !(Math.random() > this.Ic)) {
                ...
                if (!(0 <= this.gb.indexOf(a))) {
                    ...
                    this.H[a].n()
                    this.H[a].set(b, {duration: d, q: f.Easing.ease_in_out_quad})
                }
            }
        }
      , u: function(a) {
    ...
    Module.prototype = {
        cg: function(a, b) {
            ...
            var e = c.get_translate(d.O(a))
              ...
              , w = {duration: 2000,q: f.Easing.ease_out_quad}
              , r = {duration: 1000,q: f.Easing.ease_in_out_quad}
